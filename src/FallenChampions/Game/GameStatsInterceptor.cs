    ...
    public class GameStatsInterceptor
    {
            ...
            Session session, List<EventLog> events)
        {
            ...
            var gameStats = new GameStats
            {
                ...
                ArrowsCaught = matchStats.Sum(x => x.ArrowsCaught),
                ArrowsCollected = matchStats.Sum(x => x.ArrowsCollected),
                ArrowsStolen = matchStats.Sum(x => x.ArrowsStolen),
                OwnArrowsCaught = matchStats.Sum(x => x.OwnArrowsCaught),
